...
class PubMedSpider(scrapy.Spider):
    """Spider for PubMed via NCBI E-utilities.

    Spider Arguments:
        query: PubMed search query (default: neurobiology terms)
    ...
    # Default neurobiology-focused search query
    DEFAULT_QUERY = (
        "(neurobiology OR neuroscience OR neurodegeneration OR "
        "neuroplasticity OR synaptic OR neurotransmitter OR "
        '"blood-brain barrier" OR "neural stem cells" OR '
        "optogenetics OR connectomics)"
    )
